...
"\n" \
"typedef struct { uint64_t s0; uint32_t s1; } uint96;\n" \
"typedef struct { uint64_t s0; int32_t  s1; } int96;\n" \
"\n" \
...
"{\n" \
"	const uint64_t l = (uint32_t)x * (uint64_t)y, h = (x >> 32) * y + (l >> 32);\n" \
...
"#define P1P2		(P1 * (uint64_t)P2)\n" \
"#define P2P3		(P2 * (uint64_t)P3)\n" \
...
"\n" \
"inline uint32_t _addMod(const uint32_t lhs, const uint32_t rhs, const uint32_t p)\n" \
"{\n" \
"	const uint32_t c = (lhs >= p - rhs) ? p : 0;\n" \
"	return lhs + rhs - c;\n" \
"}\n" \
"\n" \
"inline uint32_t _subMod(const uint32_t lhs, const uint32_t rhs, const uint32_t p)\n" \
"{\n" \
"	const uint32_t c = (lhs < rhs) ? p : 0;\n" \
"	return lhs - rhs + c;\n" \
"}\n" \
"\n" \
"inline uint32_t _mulMod(const uint32_t lhs, const uint32_t rhs, const uint32_t p, const uint32_t p_inv)\n" \
"{\n" \
...
"}\n" \
"\n" \
"inline uint32_t seti_P1(const int32_t i) { return (i < 0) ? (uint32_t)(i + P1) : (uint32_t)i; }\n" \
"inline uint32_t seti_P2(const int32_t i) { return (i < 0) ? (uint32_t)(i + P2) : (uint32_t)i; }\n" \
"inline uint32_t seti_P3(const int32_t i) { return (i < 0) ? (uint32_t)(i + P3) : (uint32_t)i; }\n" \
"\n" \
"inline int32_t geti_P1(const uint32_t n) { return (n > P1 / 2) ? (int32_t)(n - P1) : (int32_t)n; }\n" \
"\n" \
"inline uint32_t add_P1(const uint32_t lhs, const uint32_t rhs) { return _addMod(lhs, rhs, P1); }\n" \
"inline uint32_t add_P2(const uint32_t lhs, const uint32_t rhs) { return _addMod(lhs, rhs, P2); }\n" \
"inline uint32_t add_P3(const uint32_t lhs, const uint32_t rhs) { return _addMod(lhs, rhs, P3); }\n" \
"\n" \
"inline uint32_t sub_P1(const uint32_t lhs, const uint32_t rhs) { return _subMod(lhs, rhs, P1); }\n" \
"inline uint32_t sub_P2(const uint32_t lhs, const uint32_t rhs) { return _subMod(lhs, rhs, P2); }\n" \
"inline uint32_t sub_P3(const uint32_t lhs, const uint32_t rhs) { return _subMod(lhs, rhs, P3); }\n" \
"\n" \
"inline uint32_t mul_P1(const uint32_t lhs, const uint32_t rhs) { return _mulMod(lhs, rhs, P1, P1_INV); }\n" \
"inline uint32_t mul_P2(const uint32_t lhs, const uint32_t rhs) { return _mulMod(lhs, rhs, P2, P2_INV); }\n" \
"inline uint32_t mul_P3(const uint32_t lhs, const uint32_t rhs) { return _mulMod(lhs, rhs, P3, P3_INV); }\n" \
"\n" \
...
"\n" \
"inline int64_t garner2(const uint32_t r1, const uint32_t r2)\n" \
"{\n" \
"	const uint32_t u12 = mul_P1(sub_P1(r1, r2), InvP2_P1);\n" \
"	const uint64_t n = r2 + u12 * (uint64_t)P2;\n" \
"	return (n > P1P2 / 2) ? (int64_t)(n - P1P2) : (int64_t)n;\n" \
"}\n" \
"\n" \
"inline static int96 garner3(const uint32_t r1, const uint32_t r2, const uint32_t r3)\n" \
"{\n" \
"	const uint32_t u13 = mul_P1(sub_P1(r1, r3), InvP3_P1);\n" \
"	const uint32_t u23 = mul_P2(sub_P2(r2, r3), InvP3_P2);\n" \
"	const uint32_t u123 = mul_P1(sub_P1(u13, u23), InvP2_P1);\n" \
"	const uint96 n = uint96_add_64(uint96_mul_64_32(P2P3, u123), u23 * (uint64_t)P3 + r3);\n" \
...
"	};\n" \
"\n" \
"inline uint64_t getcval(const uint64_4 c, const size_t l_64)\n" \
"{\n" \
"	const uint64_t c0_mask = (l_64 == 0) ? 0xfffffffffffffffful : 0, c1_mask = (l_64 == 1) ? 0xfffffffffffffffful : 0;\n" \
"	const uint64_t c2_mask = (l_64 == 2) ? 0xfffffffffffffffful : 0, c3_mask = (l_64 == 3) ? 0xfffffffffffffffful : 0;\n" \
"\n" \
"	return (c.s0 & c0_mask) | (c.s1 & c1_mask) | (c.s2 & c2_mask) | (c.s3 & c3_mask);\n" \
"}\n" \
"\n" \
"__kernel\n" \
"void set_P1(const __global uint32_2 * restrict const x12, __global uint32_t * restrict const y1)\n" \
"{\n" \
...
"\n" \
"__kernel\n" \
"void set_P123(const __global uint32_2 * restrict const x12, const __global uint32_t * restrict const x3, __global uint32_2 * restrict const y12, __global uint32_t * restrict const y3)\n" \
"{\n" \
"	const size_t k = get_global_id(0);\n" \
"	const uint32_2 x12k = x12[k]; const uint32_t x3k = x3[k];\n" \
"	y12[k] = x12k; y3[k] = x3k;\n" \
"}\n" \
"\n" \
"__kernel\n" \
...
"\n" \
"__kernel\n" \
"void swap_P123(__global uint32_2 * restrict const x12, __global uint32_t * restrict const x3, __global uint32_2 * restrict const y12, __global uint32_t * restrict const y3)\n" \
"{\n" \
"	const size_t k = get_global_id(0);\n" \
"	const uint32_2 x12k = x12[k], y12k = y12[k];\n" \
"	x12[k] = y12k; y12[k] = x12k;\n" \
"	const uint32_t x3k = x3[k], y3k = y3[k];\n" \
"	x3[k] = y3k; y3[k] = x3k;\n" \
"}\n" \
"\n" \
"__kernel\n" \
"void reset_P12(__global uint32_2 * restrict const x12, const uint32_t a)\n" \
"{\n" \
"	const size_t k = get_global_id(0);\n" \
"	const uint32_t v = (k < VSIZE) ? a : 0;\n" \
"	x12[k] = (uint32_2)(v, v);\n" \
"}\n" \
"\n" \
"__kernel\n" \
"void reset_P123(__global uint32_2 * restrict const x12, __global uint32_t * restrict const x3, const uint32_t a)\n" \
"{\n" \
"	const size_t k = get_global_id(0);\n" \
"	const uint32_t v = (k < VSIZE) ? a : 0;\n" \
"	x12[k] = (uint32_2)(v, v);\n" \
...
"}\n" \
"inline void frwd2_P3(uint32_t * const u_P3, const uint32_t w3)\n" \
"{\n" \
"	const uint32_t u1w_P3 = mul_P3(u_P3[1], w3);\n" \
...
"}\n" \
"inline void bkwd2_P3(uint32_t * const u_P3, const uint32_t wi3)\n" \
"{\n" \
"	const uint32_t v1_P3 = sub_P3(u_P3[0], u_P3[1]);\n" \
...
"}\n" \
"inline void sqr2_P3(uint32_t * const u_P3, const uint32_t w3)\n" \
"{\n" \
"	const uint32_t u1w_P3 = mul_P3(u_P3[1], w3);\n" \
"	const uint32_t v0_P3 = add_P3(mul_P3(u_P3[0], u_P3[0]), mul_P3(u1w_P3, u1w_P3));\n" \
"	const uint32_t v1_P3 = mul_P3(add_P3(u_P3[0], u_P3[0]), u_P3[1]);\n" \
"	u_P3[0] = add_P3(v0_P3, v0_P3); u_P3[1] = add_P3(v1_P3, v1_P3);\n" \
"}\n" \
"\n" \
"inline void read2_P12(uint32_2 * const u_P12, const __global uint32_2 * const x12, const size_t k, const uint32_t m)\n" \
"{\n" \
"	for (size_t h = 0; h < 2; ++h) u_P12[h] = x12[k + h * VSIZE * m];\n" \
"}\n" \
"inline void read2_P3(uint32_t * const u_P3, const __global uint32_t * const x3, const size_t k, const uint32_t m)\n" \
"{\n" \
"	for (size_t h = 0; h < 2; ++h) u_P3[h] = x3[k + h * VSIZE * m];\n" \
"}\n" \
"\n" \
"inline void write2_P12(__global uint32_2 * const x12, const uint32_2 * const u_P12, const size_t k, const uint32_t m)\n" \
"{\n" \
"	for (size_t h = 0; h < 2; ++h) x12[k + h * VSIZE * m] = u_P12[h];\n" \
"}\n" \
"inline void write2_P3(__global uint32_t * const x3, const uint32_t * const u_P3, const size_t k, const uint32_t m)\n" \
"{\n" \
"	for (size_t h = 0; h < 2; ++h) x3[k + h * VSIZE * m] = u_P3[h];\n" \
"}\n" \
"\n" \
"__kernel\n" \
"void forward2_P12(const __global uint32_2 * restrict const wr12, __global uint32_2 * restrict const x12, const uint32_t s, const uint32_t m, const int lm)\n" \
"{\n" \
...
"\n" \
"__kernel\n" \
"void forward2_P123(const __global uint32_2 * restrict const wr12, const __global uint32_t * restrict const wr3,\n" \
"	__global uint32_2 * restrict const x12, __global uint32_t * restrict const x3, const uint32_t s, const uint32_t m, const int lm)\n" \
"{\n" \
"	const size_t id = get_global_id(0), vid = id / VSIZE, l = id % VSIZE;\n" \
"\n" \
"	const size_t sj = s + (vid >> lm), i = vid & (m - 1), mj = vid - i, k = VSIZE * (2 * mj + i) + l;\n" \
"\n" \
"	uint32_2 u_P12[2]; read2_P12(u_P12, x12, k, m); uint32_t u_P3[2]; read2_P3(u_P3, x3, k, m);\n" \
"\n" \
...
"\n" \
"__kernel\n" \
"void backward2_P12(const __global uint32_2 * restrict const wri12, __global uint32_2 * restrict const x12, const uint32_t s, const uint32_t m, const int lm)\n" \
"{\n" \
"	const size_t id = get_global_id(0), vid = id / VSIZE, l = id % VSIZE;\n" \
"\n" \
"	const size_t sj = s + (vid >> lm), i = vid & (m - 1), mj = vid - i, k = VSIZE * (2 * mj + i) + l;\n" \
...
"\n" \
"__kernel\n" \
"void backward2_P123(const __global uint32_2 * restrict const wri12, const __global uint32_t * restrict const wri3,\n" \
"	__global uint32_2 * restrict const x12, __global uint32_t * restrict const x3, const uint32_t s, const uint32_t m, const int lm)\n" \
"{\n" \
"	const size_t id = get_global_id(0), vid = id / VSIZE, l = id % VSIZE;\n" \
"\n" \
...
"\n" \
"__kernel\n" \
"void square2_P123(const __global uint32_2 * restrict const wr12, const __global uint32_t * restrict const wr3,\n" \
"	const __global uint32_2 * restrict const wri12, const __global uint32_t * restrict const wri3,\n" \
"	__global uint32_2 * restrict const x12, __global uint32_t * restrict const x3)\n" \
"{\n" \
"	const size_t id = get_global_id(0), vid = id / VSIZE, l = id % VSIZE;\n" \
"\n" \
"	const size_t sj = get_global_size(0) / VSIZE + vid, k = VSIZE * 2 * vid + l;\n" \
"\n" \
"	uint32_2 u_P12[2]; read2_P12(u_P12, x12, k, 1); uint32_t u_P3[2]; read2_P3(u_P3, x3, k, 1);\n" \
"\n" \
...
"	const __global uint32_2 * restrict const y12, __global uint32_2 * restrict const x12, const uint64_t c)\n" \
"{\n" \
"	const size_t id = get_global_id(0), vid = id / VSIZE, l = id % VSIZE;\n" \
"\n" \
"	const size_t sj = get_global_size(0) / VSIZE + vid, k = VSIZE * 2 * vid + l;\n" \
...
"\n" \
"__kernel\n" \
"void mul2cond64_P123(const __global uint32_2 * restrict const wr12, const __global uint32_t * restrict const wr3,\n" \
"	const __global uint32_2 * restrict const wri12, const __global uint32_t * restrict const wri3,\n" \
"	const __global uint32_2 * restrict const y12, __global uint32_t * restrict const y3,\n" \
"	__global uint32_2 * restrict const x12,  __global uint32_t * restrict const x3, const uint64_t c)\n" \
"{\n" \
"	const size_t id = get_global_id(0), vid = id / VSIZE, l = id % VSIZE;\n" \
"\n" \
"	const size_t sj = get_global_size(0) / VSIZE + vid, k = VSIZE * 2 * vid + l;\n" \
...
"\n" \
"__kernel\n" \
"void mul2cond256_P123(const __global uint32_2 * restrict const wr12, const __global uint32_t * restrict const wr3,\n" \
"	const __global uint32_2 * restrict const wri12, const __global uint32_t * restrict const wri3,\n" \
"	const __global uint32_2 * restrict const y12, __global uint32_t * restrict const y3,\n" \
"	__global uint32_2 * restrict const x12,  __global uint32_t * restrict const x3, const uint64_4 c)\n" \
"{\n" \
"	const size_t id = get_global_id(0), vid = id / VSIZE, l = id % VSIZE;\n" \
"\n" \
"	const size_t sj = get_global_size(0) / VSIZE + vid, k = VSIZE * 2 * vid + l;\n" \
...
"\n" \
"__kernel\n" \
"void mul2_P123(const __global uint32_2 * restrict const wr12, const __global uint32_t * restrict const wr3,\n" \
"	const __global uint32_2 * restrict const wri12, const __global uint32_t * restrict const wri3,\n" \
"	const __global uint32_2 * restrict const y12, __global uint32_t * restrict const y3,\n" \
"	__global uint32_2 * restrict const x12,  __global uint32_t * restrict const x3)\n" \
"{\n" \
...
"\n" \
"	const uint32_2 wr12_1 = wr12[sj];\n" \
"	const uint32_t wr3_1 = wr3[sj];\n" \
"\n" \
"	uint32_2 u_P12[2]; read2_P12(u_P12, x12, k, 1); uint32_t u_P3[2]; read2_P3(u_P3, x3, k, 1);\n" \
"\n" \
"	frwd2_P12(u_P12, wr12_1); frwd2_P3(u_P3, wr3_1);\n" \
"\n" \
"	uint32_2 v_P12[2]; read2_P12(v_P12, y12, k, 1); uint32_t v_P3[2]; read2_P3(v_P3, y3, k, 1);\n" \
"\n" \
...
"}\n" \
"inline void frwd41_P3(uint32_t * const u_P3, const uint32_t w3_1)\n" \
"{\n" \
"	const uint32_t u2w1_P3 = mul_P3(u_P3[2], w3_1), u3w1_P3 = mul_P3(u_P3[3], w3_1);\n" \
...
"}\n" \
"inline void frwd42_P3(uint32_t * const u_P3, const uint32_t w3_2, const uint32_t w3_3)\n" \
"{\n" \
"	const uint32_t u1w2_P3 = mul_P3(u_P3[1], w3_2), u3w3_P3 = mul_P3(u_P3[3], w3_3);\n" \
...
"}\n" \
"inline void bkwd42_P3(uint32_t * const u_P3, const uint32_t wi3_2, const uint32_t wi3_3)\n" \
"{\n" \
"	const uint32_t v1_P3 = sub_P3(u_P3[0], u_P3[1]), v3_P3 = sub_P3(u_P3[2], u_P3[3]);\n" \
...
"}\n" \
"inline void bkwd41_P3(uint32_t * const u_P3, const uint32_t wi3_1)\n" \
"{\n" \
"	const uint32_t v2_P3 = sub_P3(u_P3[0], u_P3[2]), v3_P3 = sub_P3(u_P3[1], u_P3[3]);\n" \
...
"}\n" \
"inline void sqr42_P3(uint32_t * const u_P3, const uint32_t w3_2, const uint32_t w3_3)\n" \
"{\n" \
"	const uint32_t u1w2_P3 = mul_P3(u_P3[1], w3_2), u3w3_P3 = mul_P3(u_P3[3], w3_3);\n" \
"	const uint32_t v0_P3 = add_P3(mul_P3(u_P3[0], u_P3[0]), mul_P3(u1w2_P3, u1w2_P3));\n" \
"	const uint32_t v1_P3 = mul_P3(add_P3(u_P3[0], u_P3[0]), u_P3[1]);\n" \
"	const uint32_t v2_P3 = add_P3(mul_P3(u_P3[2], u_P3[2]), mul_P3(u3w3_P3, u3w3_P3));\n" \
"	const uint32_t v3_P3 = mul_P3(add_P3(u_P3[2], u_P3[2]), u_P3[3]);\n" \
"	u_P3[0] = add_P3(v0_P3, v0_P3); u_P3[1] = add_P3(v1_P3, v1_P3);\n" \
"	u_P3[2] = add_P3(v2_P3, v2_P3); u_P3[3] = add_P3(v3_P3, v3_P3);\n" \
"}\n" \
"\n" \
"inline void read4_P12(uint32_2 * const u_P12, const __global uint32_2 * const x12, const size_t k, const uint32_t m)\n" \
"{\n" \
"	for (size_t h = 0; h < 4; ++h) u_P12[h] = x12[k + h * VSIZE * m];\n" \
"}\n" \
"inline void read4_P3(uint32_t * const u_P3, const __global uint32_t * const x3, const size_t k, const uint32_t m)\n" \
"{\n" \
"	for (size_t h = 0; h < 4; ++h) u_P3[h] = x3[k + h * VSIZE * m];\n" \
"}\n" \
"\n" \
"inline void write4_P12(__global uint32_2 * const x12, const uint32_2 * const u_P12, const size_t k, const uint32_t m)\n" \
"{\n" \
"	for (size_t h = 0; h < 4; ++h) x12[k + h * VSIZE * m] = u_P12[h];\n" \
"}\n" \
"inline void write4_P3(__global uint32_t * const x3, const uint32_t * const u_P3, const size_t k, const uint32_t m)\n" \
"{\n" \
"	for (size_t h = 0; h < 4; ++h) x3[k + h * VSIZE * m] = u_P3[h];\n" \
"}\n" \
"\n" \
"inline void read22l_P12(uint32_2 * const u_P12, const __local uint32_2 * const X12, const size_t k, const uint32_t m)\n" \
"{\n" \
"	for (size_t h = 0; h < 2; ++h) u_P12[h] = X12[k + h * VSIZE * m];\n" \
"	for (size_t h = 0; h < 2; ++h) u_P12[h + 2] = X12[k + 1 + h * VSIZE * m];\n" \
"}\n" \
"inline void read22l_P3(uint32_t * const u_P3, const __local uint32_t * const X3, const size_t k, const uint32_t m)\n" \
"{\n" \
"	for (size_t h = 0; h < 2; ++h) u_P3[h] = X3[k + h * VSIZE * m];\n" \
"	for (size_t h = 0; h < 2; ++h) u_P3[h + 2] = X3[k + 1 + h * VSIZE * m];\n" \
"}\n" \
"\n" \
"inline void write22l_P12(__local uint32_2 * const X12, const uint32_2 * const u_P12, const size_t k, const uint32_t m)\n" \
"{\n" \
"	for (size_t h = 0; h < 2; ++h) X12[k + h * VSIZE * m] = u_P12[h];\n" \
"	for (size_t h = 0; h < 2; ++h) X12[k + 1 + h * VSIZE * m] = u_P12[h + 2];\n" \
"}\n" \
"inline void write22l_P3(__local uint32_t * const X3, const uint32_t * const u_P3, const size_t k, const uint32_t m)\n" \
"{\n" \
"	for (size_t h = 0; h < 2; ++h) X3[k + h * VSIZE * m] = u_P3[h];\n" \
"	for (size_t h = 0; h < 2; ++h) X3[k + 1 + h * VSIZE * m] = u_P3[h + 2];\n" \
"}\n" \
"\n" \
"inline void read4l_P12(uint32_2 * const u_P12, const __local uint32_2 * const X12, const size_t k, const uint32_t m)\n" \
"{\n" \
"	for (size_t h = 0; h < 4; ++h) u_P12[h] = X12[k + h * VSIZE * m];\n" \
"}\n" \
"inline void read4l_P3(uint32_t * const u_P3, const __local uint32_t * const X3, const size_t k, const uint32_t m)\n" \
"{\n" \
"	for (size_t h = 0; h < 4; ++h) u_P3[h] = X3[k + h * VSIZE * m];\n" \
"}\n" \
"\n" \
"inline void write4l_P12(__local uint32_2 * const X12, const uint32_2 * const u_P12, const size_t k, const uint32_t m)\n" \
"{\n" \
"	for (size_t h = 0; h < 4; ++h) X12[k + h * VSIZE * m] = u_P12[h];\n" \
"}\n" \
"inline void write4l_P3(__local uint32_t * const X3, const uint32_t * const u_P3, const size_t k, const uint32_t m)\n" \
"{\n" \
"	for (size_t h = 0; h < 4; ++h) X3[k + h * VSIZE * m] = u_P3[h];\n" \
"}\n" \
"\n" \
"__kernel\n" \
"void forward4_P12(const __global uint32_2 * restrict const wr12, __global uint32_2 * restrict const x12, const uint32_t s, const uint32_t m, const int lm)\n" \
"{\n" \
"	const size_t id = get_global_id(0), vid = id / VSIZE, l = id % VSIZE;\n" \
"\n" \
...
"\n" \
"__kernel\n" \
"void forward4_P123(const __global uint32_2 * restrict const wr12, const __global uint32_t * restrict const wr3,\n" \
"	__global uint32_2 * restrict const x12, __global uint32_t * restrict const x3, const uint32_t s, const uint32_t m, const int lm)\n" \
"{\n" \
"	const size_t id = get_global_id(0), vid = id / VSIZE, l = id % VSIZE;\n" \
"\n" \
"	const size_t sj = s + (vid >> lm), i = vid & (m - 1), mj = vid - i, k = VSIZE * (4 * mj + i) + l;\n" \
"\n" \
"	uint32_2 u_P12[4]; read4_P12(u_P12, x12, k, m); uint32_t u_P3[4]; read4_P3(u_P3, x3, k, m);\n" \
"\n" \
...
"void forward16_P12(const __global uint32_2 * restrict const wr12, __global uint32_2 * restrict const x12, const uint32_t s, const uint32_t m, const int lm)\n" \
"{\n" \
...
"\n" \
"__kernel __attribute__((work_group_size_hint(16 / 4 * VSIZE, 1, 1)))\n" \
"void forward16_P3(const __global uint32_t * restrict const wr3, __global uint32_t * restrict const x3, const uint32_t s, const uint32_t m, const int lm)\n" \
"{\n" \
"	__local uint32_t X3[16 * VSIZE];\n" \
"\n" \
"	const size_t gid = get_global_id(0), vid = gid / VSIZE, l = gid % VSIZE;\n" \
"	const size_t lid = get_local_id(0), i = lid / VSIZE, iv = lid & (size_t)~(VSIZE - 1);\n" \
"\n" \
...
"	const size_t sj4 = s * 4 + (vid_blk >> (lm + 2)) + i, sj = sj4 / 4;\n" \
"\n" \
"	uint32_t u_P3[4]; read4_P3(u_P3, x3, k0 + miv, 4 * m);\n" \
...
"	barrier(CLK_LOCAL_MEM_FENCE);\n" \
"\n" \
"	uint32_t v_P3[4]; read4l_P3(v_P3, X3, 4 * iv + l, 1);\n" \
...
"\n" \
"__kernel\n" \
"void backward4_P12(const __global uint32_2 * restrict const wri12, __global uint32_2 * restrict const x12, const uint32_t s, const uint32_t m, const int lm)\n" \
"{\n" \
"	const size_t id = get_global_id(0), vid = id / VSIZE, l = id % VSIZE;\n" \
"\n" \
"	const size_t sj = s + (vid >> lm), i = vid & (m - 1), mj = vid - i, k = VSIZE * (4 * mj + i) + l;\n" \
...
"\n" \
"__kernel\n" \
"void backward4_P123(const __global uint32_2 * restrict const wri12, const __global uint32_t * restrict const wri3,\n" \
"	__global uint32_2 * restrict const x12, __global uint32_t * restrict const x3, const uint32_t s, const uint32_t m, const int lm)\n" \
"{\n" \
"	const size_t id = get_global_id(0), vid = id / VSIZE, l = id % VSIZE;\n" \
"\n" \
...
"\n" \
"__kernel __attribute__((work_group_size_hint(16 / 4 * VSIZE, 1, 1)))\n" \
"void backward16_P12(const __global uint32_2 * restrict const wri12, __global uint32_2 * restrict const x12, const uint32_t s, const uint32_t m, const int lm)\n" \
"{\n" \
"	__local uint32_2 X12[16 * VSIZE];	// 32 KB => VSIZE = 256\n" \
"\n" \
"	const size_t gid = get_global_id(0), vid = gid / VSIZE, l = gid % VSIZE;\n" \
...
"\n" \
"__kernel __attribute__((work_group_size_hint(16 / 4 * VSIZE, 1, 1)))\n" \
"void backward16_P3(const __global uint32_t * restrict const wri3, __global uint32_t * restrict const x3, const uint32_t s, const uint32_t m, const int lm)\n" \
"{\n" \
"	__local uint32_t X3[16 * VSIZE];\n" \
"\n" \
"	const size_t gid = get_global_id(0), vid = gid / VSIZE, l = gid % VSIZE;\n" \
...
"	const size_t sj4 = s * 4 + (vid_blk >> (lm + 2)) + i, sj = sj4 / 4;\n" \
"\n" \
"	uint32_t v_P3[4]; read4_P3(v_P3, x3, k0 + 4 * miv, m);\n" \
...
"	barrier(CLK_LOCAL_MEM_FENCE);\n" \
"\n" \
"	uint32_t u_P3[4]; read4l_P3(u_P3, X3, iv + l, 4);\n" \
...
"\n" \
"__kernel\n" \
"void square4_P123(const __global uint32_2 * restrict const wr12, const __global uint32_t * restrict const wr3,\n" \
"	const __global uint32_2 * restrict const wri12, const __global uint32_t * restrict const wri3,\n" \
"	__global uint32_2 * restrict const x12, __global uint32_t * restrict const x3)\n" \
"{\n" \
"	const size_t id = get_global_id(0), vid = id / VSIZE, l = id % VSIZE;\n" \
...
"	const size_t sj = get_global_size(0) / VSIZE + vid, k = VSIZE * 4 * vid + l;\n" \
"\n" \
"	uint32_2 u_P12[4]; read4_P12(u_P12, x12, k, 1); uint32_t u_P3[4]; read4_P3(u_P3, x3, k, 1);\n" \
"\n" \
"	frwd41_P12(u_P12, wr12[sj]); frwd41_P3(u_P3, wr3[sj]);\n" \
...
"}\n" \
"inline void frwd4_P3(const __global uint32_t * restrict const wr3, const __global uint32_t * restrict const x3,\n" \
"	__local uint32_t * const X3, const size_t kg, const size_t k, const size_t m, const size_t sj)\n" \
"{\n" \
"	uint32_t u_P3[4]; read4_P3(u_P3, x3, kg + k, m);\n" \
"	frwd41_P3(u_P3, wr3[sj]);\n" \
"	frwd42_P3(u_P3, wr3[2 * sj], wr3[2 * sj + 1]);\n" \
...
"}\n" \
"inline void bkwd4_P3(const __global uint32_t * restrict const wri3, const __local uint32_t * const X3,\n" \
"	__global uint32_t * restrict const x3, const size_t kg, const size_t k, const size_t m, const size_t sj)\n" \
"{\n" \
"	uint32_t u_P3[4]; read4l_P3(u_P3, X3, k, m);\n" \
"	bkwd42_P3(u_P3, wri3[2 * sj], wri3[2 * sj + 1]);\n" \
"	bkwd41_P3(u_P3, wri3[sj]);\n" \
...
"}\n" \
"inline void sqr4l_P3(const __global uint32_t * restrict const wr3, const __global uint32_t * restrict const wri3,\n" \
"	__local uint32_t * const X3, const size_t k, const size_t sj)\n" \
"{\n" \
"	uint32_t u_P3[4]; read4l_P3(u_P3, X3, k, 1);\n" \
"	frwd41_P3(u_P3, wr3[sj]);\n" \
...
"}\n" \
"inline void sqr22l_P3(const __global uint32_t * restrict const wr3,\n" \
"	__local uint32_t * const X3, const size_t k, const size_t sj)\n" \
"{\n" \
"	uint32_t u_P3[4]; read22l_P3(u_P3, X3, k, 1);\n" \
"	const uint32_t w3 = wr3[sj];\n" \
...
"\n" \
"__kernel __attribute__((work_group_size_hint(8 / 4 * VSIZE, 1, 1)))\n" \
"void square8_P3(const __global uint32_t * restrict const wr3, const __global uint32_t * restrict const wri3,\n" \
"	__global uint32_t * restrict const x3)\n" \
"{\n" \
"	__local uint32_t X3[8 * VSIZE];\n" \
"\n" \
"	const size_t n_2 = get_global_size(0) * 2 / VSIZE, sj2 = n_2 + get_global_id(0) * 2 / VSIZE;\n" \
"	const size_t k_group = get_group_id(0) * 8 * VSIZE, i = get_local_id(0);\n" \
"\n" \
...
"\n" \
"__kernel __attribute__((work_group_size_hint(16 / 4 * VSIZE, 1, 1)))\n" \
"void square16_P3(const __global uint32_t * restrict const wr3, const __global uint32_t * restrict const wri3,\n" \
"	__global uint32_t * restrict const x3)\n" \
"{\n" \
"	__local uint32_t X3[16 * VSIZE];\n" \
"\n" \
...
"\n" \
"__kernel\n" \
"void mul4cond64_P123(const __global uint32_2 * restrict const wr12, const __global uint32_t * restrict const wr3,\n" \
"	const __global uint32_2 * restrict const wri12, const __global uint32_t * restrict const wri3,\n" \
"	const __global uint32_2 * restrict const y12, const __global uint32_t * restrict const y3,\n" \
"	__global uint32_2 * restrict const x12, __global uint32_t * restrict const x3, const uint64_t c)\n" \
"{\n" \
"	const size_t id = get_global_id(0), vid = id / VSIZE, l = id % VSIZE;\n" \
"\n" \
...
"\n" \
"__kernel\n" \
"void mul4cond256_P123(const __global uint32_2 * restrict const wr12, const __global uint32_t * restrict const wr3,\n" \
"	const __global uint32_2 * restrict const wri12, const __global uint32_t * restrict const wri3,\n" \
"	const __global uint32_2 * restrict const y12, const __global uint32_t * restrict const y3,\n" \
"	__global uint32_2 * restrict const x12, __global uint32_t * restrict const x3, const uint64_4 c)\n" \
"{\n" \
...
"\n" \
"__kernel\n" \
"void mul4_P123(const __global uint32_2 * restrict const wr12, const __global uint32_t * restrict const wr3,\n" \
"	const __global uint32_2 * restrict const wri12, const __global uint32_t * restrict const wri3,\n" \
"	const __global uint32_2 * restrict const y12, const __global uint32_t * restrict const y3,\n" \
"	__global uint32_2 * restrict const x12, __global uint32_t * restrict const x3)\n" \
"{\n" \
...
"\n" \
"	const uint32_2 wr12_1 = wr12[sj], wr12_2 = wr12[2 * sj], wr12_3 = wr12[2 * sj + 1];\n" \
"	const uint32_t wr3_1 = wr3[sj], wr3_2 = wr3[2 * sj], wr3_3 = wr3[2 * sj + 1];\n" \
"\n" \
"	uint32_2 u_P12[4]; read4_P12(u_P12, x12, k, 1); uint32_t u_P3[4]; read4_P3(u_P3, x3, k, 1);\n" \
"\n" \
...
"\n" \
"	uint32_2 v_P12[4]; read4_P12(v_P12, y12, k, 1); uint32_t v_P3[4]; read4_P3(v_P3, y3, k, 1);\n" \
"\n" \
...
"}\n" \
"\n" \
"inline uint32_t barrett(const uint64_t a, const uint32_t b, const uint32_t b_inv, const int b_s, uint32_t * a_p)\n" \
"{\n" \
...
"	// 0 <= h < 1 + 1/2 + 1/2 => h = 1.\n" \
"\n" \
"	const uint32_t d = mul_hi((uint32_t)(a >> b_s), b_inv), r = (uint32_t)a - d * b;\n" \
"	const bool o = (r >= b);\n" \
"	*a_p = o ? d + 1 : d;\n" \
"	return o ? r - b : r;\n" \
"}\n" \
"\n" \
"inline int32_t reduce64(int64_t * f, const uint32_t b, const uint32_t b_inv, const int b_s)\n" \
"{\n" \
"	// 1- t < 2^63 => t_h < 2^34. We must have t_h < 2^29 b => b > 32\n" \
"	// 2- t < 2^22 b^2 => t_h < b^2 / 2^7. If 2 <= b < 32 then t_h < 32^2 / 2^7 = 2^8 < 2^29 b\n" \
"	const uint64_t t = abs(*f);\n" \
"	const uint64_t t_h = t >> 29;\n" \
"	const uint32_t t_l = (uint32_t)t & ((1u << 29) - 1);\n" \
"\n" \
...
"	return s ? -(int32_t)r_l : (int32_t)r_l;\n" \
"}\n" \
"\n" \
"inline int32_t reduce96(int96 * f, const uint32_t b, const uint32_t b_inv, const int b_s)\n" \
"{\n" \
"	const uint96 t = int96_abs(*f);\n" \
"	const uint64_t t_h = ((uint64_t)t.s1 << (64 - 29)) | (t.s0 >> 29);\n" \
"	const uint32_t t_l = (uint32_t)t.s0 & ((1u << 29) - 1);\n" \
"\n" \
"	uint32_t d_h, r_h = barrett(t_h, b, b_inv, b_s, &d_h);\n" \
"	uint32_t d_l, r_l = barrett(((uint64_t)r_h << 29) | t_l, b, b_inv, b_s, &d_l);\n" \
"	const uint64_t d = ((uint64_t)d_h << 29) | d_l;\n" \
...
"\n" \
"__kernel\n" \
"void normalize2a(const __global uint32_2 * restrict const bb_inv, __global int64_t * restrict const f,\n" \
"				 __global uint32_2 * restrict const z12, const int b_s)\n" \
"{\n" \
"	const size_t id = get_global_id(0);\n" \
"	const size_t i = id % VSIZE, j = id / VSIZE, k0 = j * (VSIZE * CSIZE) + i;\n" \
"	const uint32_t b = bb_inv[i].s0, b_inv = bb_inv[i].s1;\n" \
"	int64_t a = 0;\n" \
...
"		const int32_t r = reduce64(&a, b, b_inv, b_s);\n" \
...
"\n" \
"__kernel\n" \
"void normalize2b(const __global uint32_2 * restrict const bb_inv, const __global int64_t * restrict const f,\n" \
"				 __global uint32_2 * restrict const z12, const int b_s)\n" \
"{\n" \
"	const size_t id = get_global_id(0);\n" \
...
"	{\n" \
"		const size_t k = k0 + c * VSIZE;\n" \
"		z12[k] = add_P12(z12[k], (uint32_2)(seti_P1((int32_t)a), seti_P2((int32_t)a)));\n" \
"		// if (abs(a) > 1) throw;\n" \
"	}\n" \
"}\n" \
"\n" \
"__kernel\n" \
"void normalize3a(const __global uint32_2 * restrict const bb_inv, __global int64_t * restrict const f,\n" \
"				 __global uint32_2 * restrict const z12, __global uint32_t * restrict const z3, const int b_s)\n" \
"{\n" \
"	const size_t id = get_global_id(0);\n" \
"	const size_t i = id % VSIZE, j = id / VSIZE, k0 = j * (VSIZE * CSIZE) + i;\n" \
"	const uint32_t b = bb_inv[i].s0, b_inv = bb_inv[i].s1;\n" \
...
"		const int32_t r = reduce96(&a, b, b_inv, b_s);\n" \
...
"\n" \
"__kernel\n" \
"void normalize3b(const __global uint32_2 * restrict const bb_inv, const __global int64_t * restrict const f,\n" \
"				 __global uint32_2 * restrict const z12, __global uint32_t * restrict const z3, const int b_s)\n" \
"{\n" \
"	const size_t id = get_global_id(0);\n" \
"	const size_t i = id % VSIZE, j = (id / VSIZE + 1) & (get_global_size(0) / VSIZE - 1);\n" \
...
"	{\n" \
"		const size_t k = k0 + c * VSIZE;\n" \
"		z12[k] = add_P12(z12[k], (uint32_2)(seti_P1((int32_t)a), seti_P2((int32_t)a))); z3[k] = add_P3(z3[k], seti_P3((int32_t)a));\n" \
"		// if (abs(a) > 1) throw;\n" \
"	}\n" \
"}\n" \
"";
